class Dog {
  ...
  displayDog() {
    document.getElementById("dog-card").innerHTML = `<div class="dog-card">
  ...
  getLiked() {
    ...
    dogVerdict.innerHTML = `<img src="/images/badge-like.png"/>`;
  ...
  getNoped() {
    const dogVerdict = document.getElementById("dog-verdict");
    dogVerdict.innerHTML = `<img src="/images/badge-nope.png"/>`;
    dogVerdict.classList.remove("hidden");
    this.hasBeenSwiped = true;
  }
}
